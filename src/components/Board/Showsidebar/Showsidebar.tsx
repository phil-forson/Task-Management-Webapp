...
const Showsidebar = ({ setShowSidebar }: ShowsidebarProps) => {
  return (
    <div className="absolute bg-mainPurple rounded-r-[100px] w-[50px] h-[48px] bottom-14 left-0 flex justify-center items-center cursor-pointer" onClick={() => setShowSidebar(true)}>
