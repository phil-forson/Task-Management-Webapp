...
const Sidebar = ({
  ...
  return (
    <>
    <div className="relative w-[300px] min-w-[300px] h-[100vh] " style={{gridColumn: 1, gridRow: 2}}>
    <div className="max-w-[300px] min-w-[300px] fixed left-0 top-[85px] border-r-[1px] border-lightGrey dark:border-darkLines h-[100vh] dark:bg-darkGrey text-mediumGrey z-10 bg-white" style={{gridColumn: 1}}>
      <div className="mr-5 pt-3">
        ...
        <div className="h-[48px] ">
          <div className="flex ml-8 items-center h-full">
            ...
            <div className="ml-5 text-mainPurple flex items-center cursor-pointer" onClick={openBoardModal}>
    ...
    {boardModalOpen && <Modal handleClose={closeBoardModal} component={<AddNewBoard closeModal={closeBoardModal} />}/>}
    </>
  );
};
